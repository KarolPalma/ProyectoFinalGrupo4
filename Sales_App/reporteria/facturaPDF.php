...
require('../facturasVentas/recuperarFactura.php');
...
$pdf->Ln(10);
$pdf->Cell(60,8,'SALES APP',0,1,'C');
$pdf->SetFont('Helvetica','',7);
$pdf->Cell(60,4,'TIENDA EN LINEA - SALES APP',0,1,'C');
$pdf->Cell(60,4,'COL. LOVELESS DISTRITO 7 TIENDA NO. 1 ',0,1,'C');
$pdf->Cell(60,4,'FRANCISCO MORAZAN, DISTRITO CENTRAL, HONDURAS',0,1,'C');
$pdf->Cell(60,4,'R.T.N. 08019994231345',0,1,'C');
$pdf->Cell(60,4,'relegal@salesapp.hn',0,1,'C');
...
// PRODUCTOS
$pdf->SetFont('Helvetica', '', 7);
$sql = "SELECT * FROM v_Detalles_Facturados_Ventas WHERE Id_Factura = '" . $id . "';"; 
...
$pdf->Ln(3);
$pdf->Cell(60,0,utf8_decode('consultas@salesapp.hn'),0,1,'C');
 
$pdf->Output('factura'. $idFactura . '.pdf','i');
?>