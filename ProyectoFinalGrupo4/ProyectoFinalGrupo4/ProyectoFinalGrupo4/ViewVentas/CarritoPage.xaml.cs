...
namespace ProyectoFinalGrupo4.ViewVentas
{
    ...
    public partial class CarritoPage : ContentPage
    {
        ...
        {
            bool sePuedeProcesarVenta = true;
            string productoExcede = "";
            foreach (Productos producto in productosGlobal)
            {
                if (producto.unidadesAlmacen < producto.unidadesCarrito)
                {
                    sePuedeProcesarVenta = false;
                    productoExcede = producto.nombre;
                    break;
                }
            }
            if (sePuedeProcesarVenta)
            {
