...
namespace ProyectoFinalGrupo4.ViewCompras
{
    ...
    public partial class DetallesProductoCompra : ContentPage
    {
        ...
        public DetallesProductoCompra(Productos producto)
        {
            InitializeComponent();
            ...
            txtUnidades.Text = "Unidades en Almacen: " + producto.unidadesAlmacen;
            txtPrecio.Text = "L." + string.Format("{0:#.00}", Convert.ToDecimal(producto.precioConImpuesto));

            txtCantidadesCarrito.Text = "10";
